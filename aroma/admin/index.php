    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                ...
                Good Morning <?php echo $_SESSION['uname'];  ?>!</h3>
                        ...
                        <div>
                            <div class="d-inline-flex align-items-center">
                                <h2 class="text-dark mb-1 font-weight-medium">
                                    <?php
                                    $select=$db->select_query("SELECT * FROM `tbluser` WHERE `role`<>1"); 
                                    $clients=mysqli_num_rows($select);
                                    echo "$clients";
                                        ?>       
                                </h2>
                            </div>
                        ...
                        <div>
                            <div class="d-inline-flex align-items-center">
                                ...
                                <?php
                                    ...
                                    $category=mysqli_num_rows($select);
                                    echo "$category";
                                    ?> 
                                </h2>
                            </div>
                ...
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 font-weight-medium">
                            <?php
                                $select=$db->db_select("product"); 
                                $product=mysqli_num_rows($select);
                                echo "$product";
                                    ?> 
                            </h2>
